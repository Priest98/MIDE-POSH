...
const TestimonialCard = ({ id, name, handle, text }: { id: string; name: string; handle: string; text: string; key?: React.Key }) => {
...
const CollectionCard = ({ video, title, category, isActive, index, gradient }: { video: string; title: string; category: string; isActive: boolean; index: number; gradient: string; key?: React.Key }) => {
        ...
        <section id="about" className="py-24 md:py-48 bg-luxury-beige/30 dark:bg-[#1c1c1c] transition-colors duration-500 px-6 md:px-20 overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-24 md:gap-20">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-10">
              ...
              >
                <span className="text-4xl font-serif italic text-stone-400">MipeModish</span>
              </motion.div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[1920px] mx-auto relative px-4 md:px-20 overflow-x-hidden">
            ...
            <div className="relative">
              <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 overflow-x-auto md:overflow-x-visible no-scrollbar snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0">
                ...
                {[
                  { id: "01", name: "Adunni O.", handle: "@adunni_luxury", text: "The bridal gown exceeded every dream I had. It wasn't just a dress; it was a manifestation of my personality. The attention to detail and the way it fit me was absolutely peerless. I felt like a queen on my special day, and I can't thank MipeModish enough for her vision and craftsmanship." },
                  { id: "02", name: "Boluwatife S.", handle: "@bolu_styles", text: "Precision, elegance, and soul. MipeModish doesn't just design, she transforms. A truly premium Lagos experience that rivals anything I've seen in London or Paris. The bespoke suit fits like a second skin, and the fabric quality is simply out of this world." },
